...
class MetaData:
    ...
    def output_file_name(filename: str, suffix: str, path: str, generate_json=False):
        ...
        return os.path.join(path, filename_split[0] + "_%s_evm_%s" %
                            (suffix, MetaData.format_date(MetaData.get_date())) + extension)
    ...
    def save_meta_data(self):
        ...
        self.__data['date'] = MetaData.format_date(MetaData.get_date())
